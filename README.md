...
> TO-DO LIST
> CHANGELOG HISTORY
    - v1.4.1    - Pirates, Adventurers, Colonies
    - v1.4.0    - Performance Rebuild
    - v1.3.7    >> CURRENT
    - v1.3.6
    - v1.3.51
...
| are often based on older versions of vanilla CK2 are now in fact based on the current version of those same files. This is what mostly Komi did between 2016-2018,
...
- Warbands
------------------------------------------------------
Milestone Three: Chaos in the Old World - v1.3 >> 85% COMPLETE
------------------------------------------------------
...
KNOWN ISSUES
------------------------------------------------------
- Extended Everchosen Quest isnt complete
- Artifact Rumour chain not finished
- New skaven models have a red hue
------------------------------------------------------
TO-DO LIST
------------------------------------------------------
...
- Fixed the war firing again when loading a save and meeting the requirements
...
- Commented out more non-existant events from on_actions
- Drachen religion has now been given holy-sites (not having enough or having too much holy sites can cause crashes)
...
- Fixed unborn title holders so that they would atleast be 0 years old upon inhereting titles
